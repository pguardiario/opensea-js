...
var OpenSeaPort = /** @class */ (function () {
    ...
    function OpenSeaPort(provider, apiConfig, logger) {
        ...
        // Extra stuff
        this.maxFeePerGas = new bignumber_js_1.BigNumber(3);
        this.maxPriorityFeePerGas = new bignumber_js_1.BigNumber(3);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, wyvernProtocol.wyvernExchange
                                .cancelOrder_([
                                order.exchange,
                                order.maker,
                                order.taker,
                ...
                switch (_f.label) {
                    ...
                    case 8:
                        ...
                        approvalOneCheck = function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0: return [4 /*yield*/, tokenContract.methods
                                            .getApproved(tokenId)
                                            .call()];
                                    case 1:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, wyvernProtocolReadOnly.wyvernExchange
    ...
    OpenSeaPort.prototype.validateAndPostOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.api.postOrder((0, utils_1.orderToJSON)(order))];
                    case 1:
    ...
    OpenSeaPort.prototype._getProxy = function (accountAddress, retries, wyvernProtocol) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, wyvernProtocol.wyvernProxyRegistry
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, wyvernProtocol.wyvernProxyRegistry
                                .registerProxy()
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        _c.sent();
                        _c.label = 3;
                    case 3: return [4 /*yield*/, wyvernProtocol.wyvernExchange
